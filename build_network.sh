...
# rm -rf /var/run/netns/$h1_id
# rm -rf /var/run/netns/$h2_id
# rm -rf /var/run/netns/$h3_id
# rm -rf /var/run/netns/$h4_id
# rm -rf /var/run/netns/$s1_id
# rm -rf /var/run/netns/$s2_id
